...
*/
    ...
    VkBool32                                                  amdMemoryOverallocationBehaviour = VK_FALSE;
    VkBool32                                                  amdShaderFragmentMask           = VK_FALSE;
...
*/
    ...
    VkExtensionProperties amdMemoryOverallocationBehaviour  = vk::makeExtension(VK_AMD_MEMORY_OVERALLOCATION_BEHAVIOR_EXTENSION_NAME);
